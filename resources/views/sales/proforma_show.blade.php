...
<body>
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
      ...
      @endif
        ...
        <div class="buy-now">
            <a style="margin-bottom: 75px;" href="/proforma/{{$proforma->id}}/edit" class="btn btn-danger btn-buy-now"> <i class="icon-base bx bx-edit-alt me-2 text-primary"></i> Edit</a>
        </div>
        @endif
        <div class="buy-now">
            <button id="print"
