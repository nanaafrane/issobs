<x-sales-dashboard>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-12">
                <h3 class="card-header text-primary"> <i class="icon-base bx bx-receipt text-primary me-2"></i> Cheque Payment </h3>
            </div>
        </div><br>
            ...
            <div class="col-lg-2">
                <div style="background: #cbfcffff;" class="card h-100">
                    <div class="card-body">
                        ...
                        <small class="fw-medium"> TOTAL RECEIPTS : <strong> {{$accraCount}}</strong> </small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2">
                <div style="background: #cbfcffff;" class="card h-100">
                    <div class="card-body">
                        ...
                        <small class="fw-medium"> TOTAL RECEIPTS : <strong> {{$botweCount}} </strong> </small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2">
                <div style="background: #cbfcffff;" class="card h-100">
                    <div class="card-body">
                        ...
                        <small class="fw-medium"> TOTAL RECEIPTS : <strong> {{$temaCount}} </strong> </small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2">
                <div style="background: #cbfcffff;" class="card h-100">
                    <div class="card-body">
                        ...
                        <small class="fw-medium"> TOTAL RECEIPTS : {{$takoradiCount}} </small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2">
                <div style="background: #cbfcffff;" class="card h-100">
                    <div class="card-body">
                        ...
                        <small class="fw-medium"> TOTAL RECEIPTS : <strong> {{$koforiduaCount}} </strong> </small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2">
                <div style="background: #cbfcffff;" class="card h-100">
                    <div class="card-body">
                        ...
                        <small class="fw-medium"> TOTAL RECEIPTS : <strong> {{$kumasiCount}} </strong> </small>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <table id="myTable" class="display">
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach($whtDeductedReceipt as $receipt)
                        <tr>
                            ...
                            <td>
                                <a href="{{url('receipt', $receipt->id)}}" class="btn btn-info">
                                    <i class="icon-base bx bx-bullseye text-primary me-2"></i>
                                </a>
                            </td>
                        </tr>
                        @endforeach
