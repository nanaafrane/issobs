  ...
  <!-- Content -->
    <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="col-lg-12 mb-4">
                <div  class="card h-100 bg-dark text-white">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-3 text-white"><strong> GH&#x20B5;  {{ number_format($salariesBoots->sum('boot'), 2) }} </strong> </h4> <br>
                        <small class="fw-medium"> NET SALARY : GH&#x20B5; {{ number_format($salariesBoots->sum('net_salary'), 2) }}  </small> <br>
        ...
        <div class="row">
            <div class="col-lg-12 mb-4">
                <div class="card">
                    <h5 class="card-header"> Salaries BOOTS  </h5>
                    <div class="card-body"> 
                    <div class="table-responsive text-nowrap">
                        <table class="table table-hover" id="myTable">
                            ...
                            <tbody class="table-border-bottom-0">
                                ...
                                <tr>
                                    <td> {{ $key + 1 }} </td>
                                    <td> {{ $boots->salary_month?->format('F, Y') }} </td>
                                    <td> {{$boots->employee_id}} </td>
                                    <td> {{ strtoupper($boots->employee->name) }} </td>
                                    <td> {{ $boots->role?->name }} </td>
                                    <td> {{ $boots->field->name }} </td>
                                    <td> {{ $boots->client?->name }} {{ $boots->client?->business_name }} </td>
                                    <td> {{ $boots->location }} </td>
                                    <td>  {{ number_format($boots->boot, 2) }} </td>
                                    <td>  {{ number_format($boots->net_salary, 2) }} </td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
