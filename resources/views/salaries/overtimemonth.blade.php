  ...
  <!-- Content -->
    <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="col-lg-12 mb-4">
                <div  class="card h-100 bg-dark text-white">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-3 text-white"><strong> GH&#x20B5;  {{ number_format($salariesOvertime->sum('overtime'), 2) }} </strong> </h4> <br>
                        <small class="fw-medium"> NET SALARY : GH&#x20B5; {{ number_format($salariesOvertime->sum('net_salary'), 2) }}  </small> <br>
        ...
        <div class="row">
            <div class="col-lg-12 mb-4">
                <div class="card">
                    <h5 class="card-header"> Salaries OVERTIME  </h5>
                    <div class="card-body"> 
                    <div class="table-responsive text-nowrap">
                        <table class="table table-hover" id="myTable">
                            ...
                            <tbody class="table-border-bottom-0">
                                ...
                                <tr>
                                    <td> {{ $key + 1 }} </td>
                                    <td> {{ $overtime->salary_month?->format('F, Y') }} </td>
                                    <td> {{$overtime->employee_id}} </td>
                                    <td> {{ strtoupper($overtime->employee->name) }} </td>
                                    <td> {{ $overtime->role?->name }} </td>
                                    <td> {{ $overtime->field->name }} </td>
                                    <td> {{ $overtime->client?->name }} {{ $overtime->client?->business_name }} </td>
                                    <td> {{ $overtime->location }} </td>
                                    <td> {{ number_format($overtime->overtime, 2) }} </td>
                                    <td> {{ number_format($overtime->net_salary, 2) }} </td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
        ...
        layout: {
            topStart: {
                buttons: [ 
                {
                    ...
                    {
                        extend: 'excelHtml5',
                        title:  "{{ $field->name . ' Overtime ' . \Carbon\Carbon::parse($month)->format('F Y')}}" ,
                        className: 'btn btn-secondary',
                        exportOptions: {
                            columns: ':visible'
                        }
