              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> <i class="bx bxs-user-account"></i> Employee /</span> Salaries </h4>
                ...
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link" href=" {{url('employees', $salaries[0]->employee_id)}}"><i class="bx bx-user me-1"></i> Employee Details</a>
                    </li>
                    <li class="nav-item ">
                      <a class="nav-link " href="{{url('employeesViewPayInfo', $salaries[0]->employee_id)}}" ><i class="bx bxs-comment-detail"></i> Payment Info </a
                      >
                    </li>
                    <li class="nav-item">
                            ...
                            <tbody>
                                ...
                                @if(Auth::user()->hasRole(['Invoice', 'HR Manager']))
                                    ...
                                    <tr>
                                        ...
                                        <td> {{$salary->branch}} </td>
                                        <td> GH&#x20B5; {{$salary->basic_salary}} </td>
                                        <td> GH&#x20B5; {{$salary->allowances}}</td>
                                        <td> GH&#x20B5; {{$salary->gross_salary}}</td>
                                        <td> GH&#x20B5; {{$salary->total_deductions}}</td>
                                        <td> GH&#x20B5;  {{$salary->net_salary}}</td>
