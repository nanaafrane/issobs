<x-hr-dashboard>
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
            ...
            @if((Auth::user()->hasRole(['Manager', 'Accounts', 'Officer', 'Finance Manager']) && Auth::user()->hasPermission('Accounts')))
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row ">
            <div class="col-12">
                <h3 class="card-header text-info"> <i class="icon-base bx bx-bxs-receipt"></i> Client <i class="icon-base bx bx-bxs-right-arrow-alt"></i> Create </h3>
            </div>
        </div><br>
