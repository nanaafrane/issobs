<x-hr-dashboard>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-12">
                <h3 class="card-header text-dark"> <i class="icon-base bx bx-bxs-group"></i> All System Users </h3>
            </div>
        </div><br>
            ...
            <div class="col-xxl-12 mb-6 order-0">
                <div class="card bg-dark">
                    <div class="d-flex align-items-start row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                <h1 class="text-white">{{$UsersCount}}</h1>
                                <h6 class="card-title text-white mb-3">TOTAL NUMBER OF STAFFS </h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-2">
                <div class="card shadow-none bg-transparent border border-danger">
                    <div class="card-body">
                        ...
                        <small class="fw-medium"> TOTAL STAFFS </small>
                    </div>
                </div>
            </div>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="/staff/{{$user->id}}"><i class="icon-base bx bxs-bullseye"></i> view</a>
                                        <a class="dropdown-item" href="/staff/{{$user->id}}/edit"><i class="icon-base bx bx-edit-alt me-1"></i> Edit</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
