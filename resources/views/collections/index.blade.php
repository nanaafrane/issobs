<x-sales-dashboard>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-12">
                <h3 class="card-header text-danger"> <i class="icon-base bx bx-bxs-receipt"></i> All Collections </h3>
            </div>
        </div><br>
            ...
            <div class="col">
                <table id="myTable" class="display">
                    ...
                    <tbody>
                        ...
                        @if(Auth::user()->field?->name == 'Takoradi')
                        @foreach($takoradi as $collection)
                        <tr>
                            <td> {{$collection->id}}</td>
                            <td> {{$collection->created_at->diffForHumans()}}</td>
                            <td>GH&#x20B5; {{number_format($collection->cash_amount, 2)}}</td>
                        ...
                        @if(Auth::user()->field?->name == 'Koforidua')
                        @foreach($koforidua as $collection)
                        <tr>
                            <td> {{$collection->id}}</td>
                            <td> {{$collection->created_at->diffForHumans()}}</td>
                            <td>GH&#x20B5; {{number_format($collection->cash_amount, 2)}}</td>
