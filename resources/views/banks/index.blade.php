<x-sales-dashboard>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-12">
                <h3 class="card-header text-danger"> <i class="icon-base bx bx-bxs-receipt"></i> Banks </h3>
            </div>
        </div><br>
            ...
            <div class="col-lg-2">
                <div style="background: crimson; color: white;" class="card h-100">
                    <div class="card-body">
                        ...
                        <small class="fw-medium"> TOTAL COLLECTIONS : <strong> {{0}}</strong> </small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2">
                <div style="background: crimson; color: white;" class="card h-100">
                    <div class="card-body">
                        ...
                        <small class="fw-medium"> TOTAL COLLECTIONS : {{0}} </small>
                    </div>
                </div>
            </div>
